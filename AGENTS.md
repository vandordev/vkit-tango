...
- TypeScript owns only TanStack Start and Socket.IO. The web client is generated from `contracts/openapi/openapi.json`; realtime is documented in `contracts/asyncapi/realtime.v1.yaml`.
