...
Before deploying, provide explicit production values for server-only configuration, especially `DATABASE_URL`, and verify that browser-exposed variables use the `VITE_` prefix only when they are safe to disclose.
