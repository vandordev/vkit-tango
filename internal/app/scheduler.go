...
var SchedulerModule = fx.Options(CommonModule, generatedfx.UsecaseModule, generatedfx.SchedulerModule, fx.Provide(NewSchedulerSettings, schedulerDatabase, fx.Annotate(NewSchedulerClient, fx.ParamTags(``, ``, `group:"periodic_jobs"`))), fx.Invoke(manageScheduler))
