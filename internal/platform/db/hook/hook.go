...
// function as SystemMetadata mutator.
type SystemMetadataFunc func(context.Context, *db.SystemMetadataMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f SystemMetadataFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	if mv, ok := m.(*db.SystemMetadataMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *db.SystemMetadataMutation", m)
}
